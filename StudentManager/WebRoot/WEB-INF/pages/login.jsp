	...
	<table border="0" width="1140px" cellspacing="0" cellpadding="0" id="table1">
		...
		<tr>
			...
			<td class="login_msg" width="400">
				<s:form namespace="/" action="managerAction_login">
					...
					<br/>
					用户名：<s:textfield name="name" class="msg"></s:textfield><br/><br/>
					密&nbsp;码：<s:password name="password" class="msg"></s:password><br/><br/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
