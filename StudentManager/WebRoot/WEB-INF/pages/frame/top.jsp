						...
						<div align="right">
							<table border="0" width="215" cellspacing="0" cellpadding="0" id="table6" height="23">
								<tr>
									...
									<td width="31"><p align="center"><img  src="${pageContext.request.contextPath}/images/login.gif"></td>
									<td width="55" valign="middle"><s:a namespace="/" action="managerAction_logout" target="_top"><font color="ffffff">重新登录</font></s:a></td>
								</tr>
							</table>
						</div>
						</td>
