...
<script>
    ...
    function test() {
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/user/userUI.do",
            timeout: 60000,
            async: true
        });
    }
...
<div class="main">
    <div class="main_inner clearfix" style="background-image:url('${pageContext.request.contextPath}/images/yonghu.png');
            width: 60%;height: 60%;position:absolute;margin-left:20%;
    ">
        <div class="panel"></div>
        <div id="chatArea" class="box chat">
            <div class="box_hd">
                <c:if test="${admin.id != null}">客户${admin.username}</c:if>
                <c:if test="${admin.id == null}">无客户在线</c:if>
            </div>
                ...
                <c:forEach items="${chats}" var="chat">
                        ...
                        <div class="message me">
                            ...
                            <div class="content">
                                ...
                                <%--<div class="bubble bubble_primary right no_arrow">
                                    <div class="bubble_cont">
                                        <div class="picture">
                                                <img class="qqface qqface0" title="微笑" src="${pageContext.request.contextPath}/images/spacer.gif"/>
                                        </div>
                                    </div>
                                </div>--%>
                            </div>
                    ...
                    <c:if test="${chat.whoTowho == 1}">
                        <div class="message" align="left">
                            ...
                            <div class="content">
                                <div class="nickname">${admin.username}<span class="time"><fmt:formatDate value="${chat.receiverTime}" pattern="yyyy-MM-dd HH:mm:ss"/></span></div>
            ...
            <div class="box_ft">
                ...
                <div class="box_ft_hd">
                    <div class="eaitWrap" align="left">
                        <pre id="editArea" placeholder="请输入要发送的信息" class="editArea" contenteditable="true"></pre>
                    </div>
...
<script type="text/javascript">
    function send() {
        ...
        location.href = "${pageContext.request.contextPath}/user/sendMsg.do?context="+context+"&whoTowho="+0;
        a.innerHTML = "";
    }
</script>
</body>
