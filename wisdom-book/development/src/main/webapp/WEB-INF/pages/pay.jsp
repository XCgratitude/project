...
<body>
	<form action="${pageContext.request.contextPath}/pay/pay.do" method="post">
		订单号：<INPUT TYPE="text" NAME="id" value="${pay.id}"> 支付金额：<INPUT
			TYPE="text" NAME="money" value="${pay.money}">元
		<div class="divBank">
			...
			<div style="margin-left: 20px;">
				...
				<div style="margin-bottom: 20px;">
					...
					<img name="SDB-NET-B2C" align="middle"
						src="${pageContext.request.contextPath}/bank_img/sfz.bmp" />
					<input
				...
				<div style="margin-bottom: 20px;">
					<input id="POST-NET-B2C" type="radio" name="yh"
						...
						src="${pageContext.request.contextPath}/bank_img/post.bmp" />
					<input id="BJRCB-NET-B2C" type="radio" name="yh" value="BJRCB-NET-B2C" />
					<img name="BJRCB-NET-B2C" align="middle"
						src="${pageContext.request.contextPath}/bank_img/beijingnongshang.bmp" />
					<input id="HXB-NET-B2C" type="radio" name="yh" value="HXB-NET-B2C" /> <img
						name="HXB-NET-B2C" align="middle"
						src="${pageContext.request.contextPath}/bank_img/hx.bmp" />
					<input id="CZ-NET-B2C" type="radio" name="yh" value="CZ-NET-B2C" /> <img
