...
<script type="text/javascript">
	...
	function uploadImg(){
		...
		var option={
			type:'POST',
			url:'${pageContext.request.contextPath }/user/uploadPic.do',
			dataType:'text',
			data:{
				fileName : 'upload'
			},
		...
		//提交表单
		$("#userAction_save_do").ajaxSubmit(option);
	}
</script>
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff" colSpan="3">
					...
					<input type="file" id="imgSize1File" name="upload" size="30" value="" onchange='uploadImg()'/></td>
			</tr>
			<TR>
			...
			<TR>
				<td align="center" colSpan="4" class="sep1"><img
					src="<%--${pageContext.request.contextPath}/admin${pageContext.request.contextPath}/images/shim.gif--%>">
				</td>
			</TR>
