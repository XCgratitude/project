...
<%
	...
	if (s == "1"){
		...
		out.println("<script type=\"text/javascript\">");
		out.println("alert('用户身份已过期，请重新登录！');");
		out.println("</script>");
	}else if (s == "3"){
		out.println("<script type=\"text/javascript\">");
		out.println("alert('服务器异常，请重新登录！');");
		out.println("</script>");
	}
%>
			...
			<table width="900px" border="0" cellspacing="0">
				<tr>
					<td style="padding:30px"><div style="height:470px">
							<b>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/user/index.do">首页</a>&nbsp;&raquo;&nbsp;个人用户登录</b>
							<div>
									...
									<tr>
															...
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	<td colspan="2"
																		...
																		href="${pageContext.request.contextPath}/user/register.do"><img name="image"
										...
										<td style="text-align:left; padding-top:30px; width:60%"><h1>您还没有注册？</h1>
											...
											<p style="text-align:right">
												<a href="${pageContext.request.contextPath}/user/register.do"><img
