                        ...
                        <TABLE height="100%" width="100%" border=0>
                            ...
                            <TR>
                                ...
                                <TD class=font_text align=right>
                                    [<A class=blue href="${path}/user/index.do" target=_blank>网站首页</A>]
                                    [<A class=blue href="${path}/admin/editPwdPage.do" target="MainFrame">修改密码</A>]
                                    [<A class=blue onclick="return out(this)" href="${pageContext.request.contextPath}/admin/loginOut.do" target=_top>安全退出</A>]
