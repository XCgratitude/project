...
<script type="text/javascript">
    ...
    function  ss(t,startPage) {
        if(startPage > 0 && startPage <= t){
            location.href="${pageContext.request.contextPath}/order/adminOrderNoPay.do?startPage="+startPage;
        }
    }
    ...
    function bjump(){
        ...
        if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
            if(pageCount==0){
                form3.action="${path}/order/adminOrderNoPay.do?startPage=1";
                form3.submit();
            }
            else{
                form3.action="${path}/order/adminOrderNoPay.do?startPage="+pageCount;
                form3.submit();
            }
        }
            ...
            if(page==0){
                ...
                form3.action="${path}/order/adminOrderNoPay.do?startPage="+page;
                form3.submit();
            }else{
                form3.action="${path}/order/adminOrderNoPay.do?startPage="+page;
                form3.submit();
...
<div><div class="content">
    ...
    <h2 class="h2_ch">
      <span id="tabs" class="l">
        <a id="label1" href="${path}/order/adminAllOrderPay.do" title="全部订单" class="nor">全部订单</a>
                        ...
                        <TR align="right" >
                            <TD >
                                <form action="" method="post" name="form3">
                                    ...
                                    <a href="${path}/order/adminOrderNoPay.do?startPage=1" ><img src="${pageContext.request.contextPath}/images/first.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;
                                    ...
                                    <a href="${path}/order/adminOrderNoPay.do?startPage=${pages.lastPage}" ><img src="${pageContext.request.contextPath}/images/last.gif" border="0" /></a>
