			...
			<tr>
				<td width="25%"><table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd"><img src="${pageContext.request.contextPath}/images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="${pageContext.request.contextPath }/user/modifyUserInfo.do">用户信息修改</a>
							</td>
						</tr>

						<tr>
							<td class="listtd"><img src="${pageContext.request.contextPath}/images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a href="${pageContext.request.contextPath }/order/orderList.do?id=${user.id}">订单查询</a>
							</td>
						</tr>
						<tr>
							<td class="listtd"><img src="${pageContext.request.contextPath}/images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a href="${pageContext.request.contextPath }/user/loginOut.do">用戶退出</a></td>
						</tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="${pageContext.request.contextPath}/product/index.do">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a
							href="${pageContext.request.contextPath}/user/myAccount.do">&nbsp;我的帐户</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;订单查询
					</div>
								...
								<table width="100%" border="0" cellspacing="0" class="tableopen">
									...
									<c:forEach items="${orders}" var="order">
										<tr>
											...
											<td class="tableopentd03"><a href="${pageContext.request.contextPath }/order/orderInfo.do?orderId=${order.id}">查看</a>&nbsp;&nbsp;
												<a href="${pageContext.request.contextPath }/order/deleteOrderByOrderId.do?orderId=${order.id}">刪除</a>
											</td>
										</tr>
									</c:forEach>
								</table>
