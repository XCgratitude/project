...
<header class="am-topbar am-topbar-fixed-top">
	  <div class="am-container">
	    <h1 class="am-topbar-brand">
	      <a href="${pageContext.request.contextPath}/index.jsp">聊天室</a>
	    </h1>
	    <div class="am-collapse am-topbar-collapse" id="collapse-head">
	      <ul class="am-nav am-nav-pills am-topbar-nav">
	        <li class="am-active"><a href="${pageContext.request.contextPath}/user/index.do">首页</a></li>
	        <%--<li style="align-content: center"><a href="#">项目</a></li>--%>
	      </ul>

	      <div class="am-topbar-right">
	        <button class="am-btn am-btn-secondary am-topbar-btn am-btn-sm"><span class="am-icon-pencil"><a href="${pageContext.request.contextPath}/user/register.do">注册</a></span></button>
	      </div>
	
	      <div class="am-topbar-right">
	        <button class="am-btn am-btn-primary am-topbar-btn am-btn-sm"><span class="am-icon-user"><a href="${pageContext.request.contextPath}/user/myAccount.do">登录</a> </span> </button>
	      </div>
	    </div>
	  </div>
	</header>

<input type="hidden" id="identity" value="${user.username}"/>
			    ...
			    <div class="am-comment-main" >
			        <header class="am-comment-hd">
			            <div class="am-comment-meta">
			              <a ff="nickname" href="#link-to-user" class="am-comment-author">我</a>
