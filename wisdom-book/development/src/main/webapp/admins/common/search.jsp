...
</select><input type="text" id="orderNo" name="orderNo" title="请输入订单号" class="text20 medium gray" value="${orderNo}" /><input type="text" id="phone" name="phone" title="请输入联系电话" class="text20 medium gray" value="${phone}" /><input type="button" class="hand btn60x20 sub1" value="" /><!-- <input type="reset" class="hand btn60x20" value="重置" /> -->&nbsp;&nbsp;<a id="highSearchButton" href="javascript:void(0);" onclick="highSearch()">高级搜索</a>
</p>
