...
<div><div class="content">
    ...
    <div class="loc icon"><samp class="t12"></samp>当前位置：商品管理&nbsp;&raquo;&nbsp;<a href="#"/>" title="品牌管理">品牌管理</a>&nbsp;&raquo;&nbsp;<span class="gray">添加品牌</span>
        <a href="#" title="返回品牌管理" class="inb btn80x20">返回品牌管理</a>
    </div>
