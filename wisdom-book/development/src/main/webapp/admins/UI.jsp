        ...
        <div id="chatArea" class="box chat">
            ...
            <div class="box_bd" id="messageList">
                <div class="message me">
                    <img class="avatar" src="${pageContext.request.contextPath}/images/error.jpg" />
                    <div class="content">
                ...
                <div class="message me">
                    ...
                    <div class="content">
                        ...
                        <div class="bubble bubble_primary right no_arrow">
                            <div class="bubble_cont">
                                <div class="picture">
                                <img class="msg-img" src="${pageContext.request.contextPath}/images/error.jpg">
                            </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="box_ft">
                ...
                <div class="box_ft_hd">
                    ...
                    <a href="javascript:void(0);" class="btn btn_send hide" id="btn_send">发送</a>
                </div>
            </div>
        </div>
    </div>
